  ...
  components: {
    ...
    schemas: {
      ...
      Flight: {
        ...
        required: ["FlightNumber", "DepartureAirport", "ArrivalAirport", "DepartureDateTime", "ArrivalDateTime"]
      },
      FlightListResponse: {
        type: "object",
        properties: {
      ...
      InvoiceListResponse: {
        type: "object",
        properties: {
          docs: { type: "array", items: { $ref: "#/components/schemas/Invoice" } }
        },
        required: ["docs"]
      },
      Customer: {
  ...
  paths: {
    ...
    "/auth/login": {
      post: {
        ...
        responses: {
          200: { description: "Token generado", content: { "application/json": { schema: { $ref: "#/components/schemas/LoginResponse" } } } },
          400: { description: "Datos faltantes", content: { "application/json": { schema: { $ref: "#/components/schemas/ErrorResponse" } } } },
    ...
    "/invoices/flights": {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [{ name: "date", in: "query", required: true, schema: { type: "string", example: "2026-03-28" }, description: "Fecha en formato YYYY-MM-DD" }],
        responses: {
          200: { description: "Lista fija de 15 vuelos con la fecha solicitada", content: { "application/json": { schema: { $ref: "#/components/schemas/FlightListResponse" } } } },
    ...
    "/invoices": {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [
          { name: "flightNumber", in: "query", required: true, schema: { type: "string", example: "1068" } },
          { name: "date", in: "query", required: true, schema: { type: "string", example: "2026-03-28" } }
        ],
        responses: {
          200: { description: "Facturas encontradas para el vuelo y la fecha", content: { "application/json": { schema: { $ref: "#/components/schemas/InvoiceListResponse" } } } },
          400: { description: "Parametro invalido", content: { "application/json": { schema: { $ref: "#/components/schemas/ErrorResponse" } } } },
          401: { description: "No autorizado", content: { "application/json": { schema: { $ref: "#/components/schemas/ErrorResponse" } } } }
        }
      }
    ...
    "/users": {
      get: {
        ...
        parameters: [
          ...
          { name: "search", in: "query", required: false, schema: { type: "string", example: "juan" } },
          { name: "segment", in: "query", required: false, schema: { type: "string", example: "frequent" } },
          { name: "status", in: "query", required: false, schema: { type: "string", example: "active" } }
        ],
        responses: {
          200: { description: "Clientes o empleados", content: { "application/json": { schema: { oneOf: [{ $ref: "#/components/schemas/CustomerListResponse" }, { $ref: "#/components/schemas/EmployeeListResponse" }] } } } },
          401: { description: "No autorizado", content: { "application/json": { schema: { $ref: "#/components/schemas/ErrorResponse" } } } }
        }
      }
    }
